...
public class EmployeeManagementServiceImpl implements EmployeeManagementService {
	...
	public boolean approveCandidates(ApproveRequestDTO approveRequestDTO, Long userId, Long companyId) {
		...
		if (toMail==null) {
			toMail=employeePersonalInfo.getEmailId();
			}
		if (toMail != null) {
			...
			mailDto.setBody("Dear " + save.getEmployeePersonalInfo().getFirstName() + " "
					...
					+ "your FLINKO Application login credentials. Please login and access FLINKO. If you are unable to login, please share a screenshot of the error page to flinko.app@gmail.com"
					...
					+ "Thanks and Regards," + "\r\n" + "Team "+save.getEmployeePersonalInfo().getCompanyInfo().getCompanyName());
	...
	public WorkInformationDTO addWorkInformation(WorkInformationDTO workInformation, Long employeeInfoId,
		...
		if (workInformation.getOfficialId() == null || workInformation.getOfficialId() == 0) {
			...
			employeeOfficialInfo.setEmployeementStatus(workInformation.getEmployeementStatus());
