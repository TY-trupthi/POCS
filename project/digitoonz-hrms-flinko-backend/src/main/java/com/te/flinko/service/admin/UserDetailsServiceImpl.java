	...
	public String addExistingEmployee(Long companyId, String employeeId,
		...
		if (toMail != null) {
			...
			mailDto.setBody("Dear " + saveEmployeeLoginInfo.getEmployeePersonalInfo().getFirstName() + " "
					...
					+ "your official email ID login credentials. Please login and access FLiNKO. If you are unable to login, please share a screenshot of the error page to flinko.app@gmail.com"
