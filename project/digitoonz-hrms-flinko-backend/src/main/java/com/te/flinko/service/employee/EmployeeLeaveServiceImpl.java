...
public class EmployeeLeaveServiceImpl implements EmployeeLeaveService {
	...
	public EmployeeDropdownDTO getReportingManager(Long employeeInfoId) {
		EmployeeReportingInfo employeeReportingInfo = employeeReportingInfoRepository
				.findByEmployeePersonalInfoEmployeeInfoId(employeeInfoId);
		if (employeeReportingInfo == null || employeeReportingInfo.getReportingManager() == null
				|| employeeReportingInfo.getReportingManager().getEmployeeOfficialInfo() == null) {
			return null;
		}
		EmployeePersonalInfo reportingHR = employeeReportingInfo.getReportingManager();
